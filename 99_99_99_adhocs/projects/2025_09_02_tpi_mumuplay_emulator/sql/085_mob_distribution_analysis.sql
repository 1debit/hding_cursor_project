-- Title: MOB Distribution Analysis for Pie Charts
-- Intent: Get MOB distribution data for 4 different user groups
-- Inputs: RISK.TEST.all_logins_with_dwn, chime.finance.members
-- Output: MOB distribution data for visualization

-- 1. US Network Carrier MOB Distribution
WITH us_users AS (
    SELECT DISTINCT
        a.user_id,
